        ...
        <div className="">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-10">
                ...
                <div className="bg-gray-100 px-5 py-8 rounded-lg shadow-md flex items-center justify-between ">
                    <div>
                        ...
                        <h2 className="text-lg font-semibold text-center mt-2">Active Jobs</h2>
                    </div>
                    <p className="text-5xl text-center text-[#203f9a] font-bold">05</p>
                </div>
                <div className="bg-gray-100 px-5 py-8 rounded-lg shadow-md flex items-center justify-between ">
                    <div>
                        <span className='text-[#203f9a]'>{icons.userAdd}</span>
                        <h2 className="text-lg font-semibold text-center mt-2">New Job Requests</h2>
                    </div>
                    <p className="text-5xl text-center text-[#203f9a] font-bold">05</p>
                </div>
                <div className="bg-gray-100 px-5 py-8 rounded-lg shadow-md flex items-center justify-between ">
            ...
            <div className=" space-y-6 grid grid-cols-2 gap-4">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <h3 className="text-xl font-semibold border-b-2 border-gray-200 pb-2">New Job Requests</h3>
                        ...
                        <tbody>
                            {[1, 2, 3, 4, 5].map((index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-4 py-2 border-b border-gray-200 flex items-center gap-2">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <h3 className="text-xl font-semibold border-b-2 border-gray-200 pb-2">New Joined Sub Contractors</h3>
                    <table className="min-w-full mt-4">
                        <thead>
                            <tr>
                                <th className="px-4 py-2 border-b border-gray-200">S/N</th>
                            ...
                            {[1, 2, 3, 4, 5].map((index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-4 py-2 border-b border-gray-200 flex items-center gap-2">
                                        ...
                                        <button className="bg-[#e6e6e6] cursor-pointer text-white px-2  py-2  rounded-full">
                                            {icons.info}
                                        </button>
                                    </td>
                                </tr>
