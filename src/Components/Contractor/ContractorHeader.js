    ...
    return (
        <header className=' flex flex-wrap gap-5 items-center justify-center md:justify-between py-5'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <button className='cursor-pointer px-2 text-white py-2 border bg-[#203f9a] rounded-md'>{icons.message}</button>
                <button className='cursor-pointer px-2 text-white py-2 border bg-[#203f9a] rounded-md'>{icons.notification}</button>
                <div>
