...
const MessageSidebar = () => {
  ...
  const users = [
    ...
    { name: "Motin Mia", role: "Ceo of ToTo Company", image: "https://randomuser.me/api/portraits/men/48.jpg" },
  ];

  return (
    <div className="w-full max-w-md mx-auto bg-[#F3F5FA] rounded-lg border-gray-100 border-2 p-4">
