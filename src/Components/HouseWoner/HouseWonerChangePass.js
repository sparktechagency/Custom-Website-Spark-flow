        ...
        <div className="max-w-md mx-auto my-10 p-6 bg-white rounded-lg shadow-lg">
            ...
            {formStage === 1 && (
                <div>
                    ...
                    <button
                        ...
                        className="w-full py-2 bg-[#1f3d95] cursor-pointer text-white rounded-md hover:bg-[#183077]"
                    >
                        Change Password
                    </button>
                    ...
                    <p className="text-center mt-4 text-sm">
                        ...
                        <span onClick={() => setFormStage(2)} className="text-[#1f3d95] cursor-pointer font-semibold">Reset it here</span>
                    </p>
                </div>
            )}
            ...
            {formStage === 2 && (
                <div>
                    ...
                    <button
                        ...
                        className="w-full py-2 cursor-pointer bg-[#1f3d95] text-white rounded-md hover:bg-[#183077]"
                    >
                        Send OTP
                    </button>
                    ...
                    <p className="text-center mt-4 text-sm">
                        ...
                        <span onClick={() => setFormStage(1)} className="text-[#1f3d95] cursor-pointer font-semibold">Go back to change password</span>
                    </p>
                </div>
            )}
            ...
            {formStage === 3 && (
                <div>
                    ...
                    <p className="text-center mt-4 text-sm">
                        ...
                        <span className="text-[#1f3d95] cursor-pointer font-semibold">Resend OTP</span>
                    </p>
                </div>
            )}
            ...
            {formStage === 4 && (
                <div>
                    ...
                    <button
                        onClick={handleChangePassword}
                        className="w-full cursor-pointer py-2 bg-[#1f3d95] text-white rounded-md hover:bg-[#183077]"
                    >
                        Update Password
                    </button>
                </div>
...
export default HouseWonerChangePass;
