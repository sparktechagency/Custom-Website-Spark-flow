        ...
        <div className="max-w-lg mx-auto my-10">
            ...
            <div className="flex bg-gray-100  p-6 rounded-lg items-center justify-between mb-4">
                ...
                <button
                    ...
                    className={`${emailNotification ? 'bg-[#1f3d95]' : 'bg-gray-300'
            ...
            <div className="flex bg-gray-100  p-6  rounded-lg items-center justify-between">
                ...
                <button
                    ...
                    className={`${pushNotification ? 'bg-[#1f3d95]' : 'bg-gray-300'
                        } relative inline-flex items-center cursor-pointer h-6 rounded-full w-12 transition-colors`}
                >
                    <span
...
export default HouseWonerNotification;
