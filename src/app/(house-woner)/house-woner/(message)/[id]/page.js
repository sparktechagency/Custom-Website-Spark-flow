        ...
        <div className='w-full min-h-[50vh] flex items-center justify-center'>
            {
                id == "message" ? <div className='text-center'>
                    <h2 className='text-4xl font-semibold text-[#1f3d95] mb-2'>Welcome To Message</h2>
                        ...
                        <div>
                            ...
                            <div className="flex items-center border-2 border-gray-300 rounded-lg py-1 pl-3 pr-2 mt-4">
                                ...
                                <button
                                    ...
                                    className="bg-[#1f3d95] cursor-pointer text-white p-3 rounded-lg flex items-center justify-center"
                                >
